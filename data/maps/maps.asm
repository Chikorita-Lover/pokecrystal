...
;\3: environment: TOWN, ROUTE, INDOOR, CAVE, ENVIRONMENT_5, GATE, DUNGEON, or ROOFTOP
...
MapGroup_Dungeons:
	...
	map BellTower1F, TILESET_TOWER, DUNGEON, LANDMARK_BELL_TOWER, MUSIC_BELL_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BellTower2F, TILESET_TOWER, DUNGEON, LANDMARK_BELL_TOWER, MUSIC_BELL_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BellTower3F, TILESET_TOWER, DUNGEON, LANDMARK_BELL_TOWER, MUSIC_BELL_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BellTower4F, TILESET_TOWER, DUNGEON, LANDMARK_BELL_TOWER, MUSIC_BELL_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BellTower5F, TILESET_TOWER, DUNGEON, LANDMARK_BELL_TOWER, MUSIC_BELL_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BellTower6F, TILESET_TOWER, DUNGEON, LANDMARK_BELL_TOWER, MUSIC_BELL_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BellTower7F, TILESET_TOWER, DUNGEON, LANDMARK_BELL_TOWER, MUSIC_BELL_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BellTower8F, TILESET_TOWER, DUNGEON, LANDMARK_BELL_TOWER, MUSIC_BELL_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BellTower9F, TILESET_TOWER, DUNGEON, LANDMARK_BELL_TOWER, MUSIC_BELL_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map RadioTower1F, TILESET_RADIO_TOWER, INDOOR, LANDMARK_GOLDENROD_CITY, RADIO_TOWER_MUSIC | MUSIC_GOLDENROD_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RadioTower2F, TILESET_RADIO_TOWER, INDOOR, LANDMARK_GOLDENROD_CITY, RADIO_TOWER_MUSIC | MUSIC_GOLDENROD_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RadioTower3F, TILESET_RADIO_TOWER, INDOOR, LANDMARK_GOLDENROD_CITY, RADIO_TOWER_MUSIC | MUSIC_GOLDENROD_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RadioTower4F, TILESET_RADIO_TOWER, INDOOR, LANDMARK_GOLDENROD_CITY, RADIO_TOWER_MUSIC | MUSIC_GOLDENROD_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map RadioTower5F, TILESET_RADIO_TOWER, INDOOR, LANDMARK_GOLDENROD_CITY, RADIO_TOWER_MUSIC | MUSIC_GOLDENROD_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map SilverCaveRoom3, TILESET_CAVE, ROOFTOP, LANDMARK_SILVER_CAVE, MUSIC_LIGHTHOUSE, TRUE, PALETTE_AUTO, FISHGROUP_LAKE
...
MapGroup_Ecruteak:
	...
	map EcruteakBellTowerEntrance, TILESET_TOWER, INDOOR, LANDMARK_ECRUTEAK_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Goldenrod:
	...
	map GoldenrodDeptStoreRoof, TILESET_MART, ROOFTOP, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_FastShip:
	...
	map BellTowerRoof, TILESET_TOWER, ROOFTOP, LANDMARK_BELL_TOWER, MUSIC_BELL_TOWER, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Lavender:
	...
	map LavRadioTower1F, TILESET_RADIO_TOWER, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Celadon:
	...
	map CeladonMansionRoof, TILESET_MANSION, ROOFTOP, LANDMARK_CELADON_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Cianwood:
	...
	map KirksHouse, TILESET_HOUSE, INDOOR, LANDMARK_CIANWOOD_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
