...
WhitneyGroup:
	...
	db 18, CLEFAIRY,   DOUBLE_SLAP, MIMIC, ENCORE, METRONOME
...
JasmineGroup:
	...
	db 30, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, SONIC_BOOM, THUNDER_WAVE
	db 30, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, SONIC_BOOM, THUNDER_WAVE
...
Rival1Group:
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, SONIC_BOOM
	...
	db 28, MAGNEMITE,  TACKLE, THUNDERSHOCK, SONIC_BOOM, THUNDER_WAVE
	...
	db 35, MAGNETON,   THUNDERSHOCK, SONIC_BOOM, THUNDER_WAVE, SWIFT
	...
	db 34, SNEASEL,    QUICK_ATTACK, SCREECH, FEINT_ATTACK, FURY_CUTTER
	db 36, GOLBAT,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 34, MAGNETON,   THUNDERSHOCK, SONIC_BOOM, THUNDER_WAVE, SWIFT
	db 35, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
...
WillGroup:
	...
	db 41, JYNX,       DOUBLE_SLAP, LOVELY_KISS, ICE_PUNCH, PSYCHIC_M
...
ErikaGroup:
	...
	db 46, BELLOSSOM,  SUNNY_DAY, SYNTHESIS, PETAL_DANCE, SOLAR_BEAM
	db -1 ; end
...
SchoolboyGroup:
	...
	db 35, ELECTRODE,  SCREECH, SONIC_BOOM, ROLLOUT, LIGHT_SCREEN
	db 35, GROWLITHE,  SUNNY_DAY, LEER, TAKE_DOWN, FLAME_WHEEL
	db 37, VILEPLUME,  SOLAR_BEAM, SLEEP_POWDER, ACID, MOONLIGHT
	db -1 ; end
	...
	db 32, YANMA,      QUICK_ATTACK, DOUBLE_TEAM, SONIC_BOOM, SUPERSONIC
...
CooltrainerMGroup:
	...
	db 35, KINGLER,    BUBBLE_BEAM, STOMP, GUILLOTINE, PROTECT
	...
	db 32, KINGLER,    BUBBLE_BEAM, STOMP, GUILLOTINE, PROTECT
	...
	db 31, EXEGGCUTE,  LEECH_SEED, CONFUSION, SLEEP_POWDER, SOLAR_BEAM
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 25, BELLOSSOM,  ABSORB, STUN_SPORE, ACID, SOLAR_BEAM
	db -1 ; end
...
PokemaniacGroup:
	...
	; POKEMANIAC (14)
	db "BRENT@", TRAINERTYPE_MOVES
	db 41, CHANSEY,    ROLLOUT, ATTRACT, EGG_BOMB, SOFT_BOILED
	db -1 ; end
...
FisherGroup:
	...
	db 25, REMORAID,   LOCK_ON, PSYBEAM, AURORA_BEAM, BUBBLE_BEAM
	db 25, REMORAID,   LOCK_ON, PSYBEAM, AURORA_BEAM, BUBBLE_BEAM
	db -1 ; end
	...
	db 34, SEAKING,    SUPERSONIC, WATERFALL, FLAIL, FURY_ATTACK
	db 38, REMORAID,   PSYBEAM, AURORA_BEAM, BUBBLE_BEAM, HYPER_BEAM
	db -1 ; end
...
SailorGroup:
	...
	db 18, KRABBY,     BUBBLE, LEER, VISE_GRIP, HARDEN
	db 20, KRABBY,     BUBBLE_BEAM, LEER, VISE_GRIP, HARDEN
	db -1 ; end
...
Rival2Group:
	...
	db 41, MAGNETON,   THUNDERSHOCK, SONIC_BOOM, THUNDER_WAVE, SWIFT
	...
	db 45, MAGNETON,   THUNDER, SONIC_BOOM, THUNDER_WAVE, SWIFT
...
PicnickerGroup:
	...
	db 31, CLEFAIRY,   ENCORE, SING, DOUBLE_SLAP, MINIMIZE
	db -1 ; end

	; PICNICKER (17)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 37, CLEFAIRY,   ENCORE, DOUBLE_SLAP, MINIMIZE, METRONOME
	db -1 ; end
	...
	; PICNICKER (20)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 20, CLEFAIRY,   ENCORE, SING, DOUBLE_SLAP, MINIMIZE
	db -1 ; end
	...
	db 38, VENUSAUR,   SOLAR_BEAM, RAZOR_LEAF, HEADBUTT, MUD_SLAP
	db -1 ; end
...
TwinsGroup:
	...
	db 16, CLEFAIRY,   GROWL, ENCORE, DOUBLE_SLAP, METRONOME
...
RedGroup:
	...
	db 77, VENUSAUR,   SUNNY_DAY, GIGA_DRAIN, SYNTHESIS, SOLAR_BEAM
...
BlueGroup:
	...
	db 58, EXEGGUTOR,  SUNNY_DAY, LEECH_SEED, EGG_BOMB, SOLAR_BEAM
...
MysticalmanGroup:
	...
	db 25, ELECTRODE,  SCREECH, SONIC_BOOM, THUNDER, ROLLOUT
	db -1 ; end
