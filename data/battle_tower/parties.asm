...
; BattleTowerMons group 2
	...
	db BLISSEY
	db BRIGHTPOWDER
	db PSYCHIC_M, SUBMISSION, SOFT_BOILED, COUNTER
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 3
	...
	db BLISSEY
	db LEFTOVERS
	db TOXIC, REFLECT, SOFT_BOILED, PROTECT
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 6
	...
	db BLISSEY
	db LEFTOVERS
	db SOFT_BOILED, TOXIC, PROTECT, PSYCHIC_M
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 7
	...
	db BLISSEY
	db SITRUS_BERRY
	db COUNTER, SOFT_BOILED, SHADOW_BALL, THUNDERBOLT
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 55000
...
; BattleTowerMons group 9
	...
	db BLISSEY
	db LEFTOVERS
	db SOLAR_BEAM, SUNNY_DAY, SOFT_BOILED, FIRE_BLAST
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 10
	...
	db BLISSEY
	db LEFTOVERS
	db THUNDERBOLT, BLIZZARD, FIRE_BLAST, SOFT_BOILED
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 50000
