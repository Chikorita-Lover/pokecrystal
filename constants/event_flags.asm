...
; Johto story events
	...
	const EVENT_KIRK_TOOK_SHUCKIE_OR_LET_YOU_KEEP_HIM
...
; Johto hidden items
	const EVENT_BELL_TOWER_4F_HIDDEN_MAX_POTION
	const EVENT_BELL_TOWER_5F_HIDDEN_FULL_RESTORE
	const EVENT_BELL_TOWER_5F_HIDDEN_CARBOS
...
; More Crystal-exclusive events in Johto
	...
	const EVENT_KOJI_ALLOWS_YOU_PASSAGE_TO_BELL_TOWER
...
; Johto itemballs
	...
	const EVENT_BELL_TOWER_3F_FULL_HEAL
	const EVENT_BELL_TOWER_4F_ULTRA_BALL
	const EVENT_BELL_TOWER_4F_PP_UP
	const EVENT_BELL_TOWER_4F_ESCAPE_ROPE
	const EVENT_BELL_TOWER_5F_RARE_CANDY
	const EVENT_BELL_TOWER_7F_MAX_REVIVE
	const EVENT_BELL_TOWER_8F_NUGGET
	const EVENT_BELL_TOWER_8F_MAX_ELIXER
	const EVENT_BELL_TOWER_8F_FULL_RESTORE
	...
	const EVENT_ROUTE_27_TM_SOLAR_BEAM
...
; Johto people
	...
	const EVENT_BELL_TOWER_ROOF_HO_OH
...
; New to Crystal
	...
	const EVENT_ECRUTEAK_BELL_TOWER_ENTRANCE_WANDERING_SAGE
	const EVENT_BELL_TOWER_1F_SUICUNE
	const EVENT_BELL_TOWER_1F_ENTEI
	const EVENT_BELL_TOWER_1F_RAIKOU
	const EVENT_BELL_TOWER_1F_EUSINE
	const EVENT_BELL_TOWER_1F_WISE_TRIO_1
	...
	const EVENT_BELL_TOWER_1F_WISE_TRIO_2
	const EVENT_BELL_TOWER_6F_MAX_POTION
	const EVENT_BELL_TOWER_9F_HP_UP
