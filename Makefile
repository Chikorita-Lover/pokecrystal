...
pokecrystal_opt         = -Cjv -t PM_PRISM -i BYTE -n 0 -k 01 -l 0x33 -m 0x10 -r 3 -p 0
pokecrystal11_opt       = -Cjv -t PM_PRISM -i BYTE -n 1 -k 01 -l 0x33 -m 0x10 -r 3 -p 0
pokecrystal_au_opt      = -Cjv -t PM_PRISM -i BYTU -n 0 -k 01 -l 0x33 -m 0x10 -r 3 -p 0
pokecrystal_debug_opt   = -Cjv -t PM_PRISM -i BYTE -n 0 -k 01 -l 0x33 -m 0x10 -r 3 -p 0
pokecrystal11_debug_opt = -Cjv -t PM_PRISM -i BYTE -n 1 -k 01 -l 0x33 -m 0x10 -r 3 -p 0
pokecrystal11_vc_opt    = -Cjv -t PM_PRISM -i BYTE -n 1 -k 01 -l 0x33 -m 0x10 -r 3 -p 0
