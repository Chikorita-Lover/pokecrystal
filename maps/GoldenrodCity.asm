...
GoldenrodCity_MapEvents:
	...
	warp_event 11, 15, GOLDENROD_MAGNET_TRAIN_STATION, 2
	warp_event 29,  5, GOLDENROD_FLOWER_SHOP, 1
	warp_event 33,  7, GOLDENROD_PP_SPEECH_HOUSE, 1
	...
	warp_event  9,  7, GOLDENROD_UNDERGROUND_SWITCH_ROOM_ENTRANCES, 8
	...
	def_bg_events
	bg_event  9, 15, BGEVENT_READ, GoldenrodCityStationSign
	...
	bg_event  7,  7, BGEVENT_READ, GoldenrodCityUndergroundSignNorth
	...
	object_event 21, 29, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_WANDER, 1, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityCooltrainerF2Script, EVENT_GOLDENROD_CITY_CIVILIANS
	...
	object_event  8, 16, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityRocket2Script, EVENT_GOLDENROD_CITY_ROCKET_TAKEOVER
