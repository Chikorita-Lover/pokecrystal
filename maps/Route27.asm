...
Route27_MapEvents:
	...
	object_event 60, 12, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_ITEMBALL, 0, Route27TMSolarBeam, EVENT_ROUTE_27_TM_SOLAR_BEAM
