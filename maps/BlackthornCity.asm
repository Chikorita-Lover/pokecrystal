...
BlackthornCity_MapEvents:
	...
	warp_event 11, 21, BLACKTHORN_DRAGON_SPEECH_HOUSE, 1
	...
	bg_event 15, 13, BGEVENT_READ, BlackthornGymSign
	...
	object_event 36, 17, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, BlackthornCooltrainerF2Script, -1
